...
############################################### Slide 10	
summary2(ita, "btbm19cc.math",  weightVar="matwgt", omittedLevels = TRUE)	
############################################### Slide 11	
############################################### Slide 12	
...
############################################### Slide 27	
ita$sdTimeMat <- apply(ita[,vnm], 1, sd, na.rm=TRUE)/60	
ita$sdTimeSci <- apply(ita[,vns], 1, sd, na.rm=TRUE)/60	
############################################### Slide 28	
